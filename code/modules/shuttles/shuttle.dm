...
/datum/shuttle
	...
	var/defer_initialisation = FALSE //this shuttle will/won't be initialized automatically. If set to true, you are responsible for initializing the shuttle manually.
