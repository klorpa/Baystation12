...
/decl/cultural_info/faction/scg/fleet
	...
	basic training and on-ship training for their rating (specialty). Commissioned officer candidates require at least a \
...
/decl/cultural_info/faction/torchco
	...
	description = "The Expeditionary Corps Organization is a government-owned, publicly traded limited liability company assembled from the corporate \
	backers who assisted in funding the Torch project when it opened five years ago. Major players include NanoTrasen, Xynergy and \
	Hephaestus Industries, as well as dozens of others. The Expeditionary Corps Organization reports its earnings and operation plans directly to a board of \
	...
	While on the surface the Expeditionary Corps Organization appears to have noble goals, it is in reality a compromise between the noble ideals of pioneering \
	science, and the corporate desire to make a quick buck off whatever is found. Rumors also abound about shady practices, hidden \
...
/decl/cultural_info/faction/gcc
	...
	bordered by the Sol Central Government towards the galactic center. The capital of the Confederation is the city of Ameranth on the planet of Terra \
	in the Gilgamesh system. Externally heavily militant and isolationist, the GCC, internally, is heavily libertarian, with \
	a strong focus on independent planetary government with the GCC itself only handling defense, foreign relations and some intergalactic trade. \
...
/decl/cultural_info/faction/remote/xynergy
	...
	training the giant armored serpentids."
	economic_power = 1.1
...
/decl/cultural_info/faction/remote/hephaestus
	...
	The leading manufacturer of military grade personal weapons, assault vehicles, defense systems and security measures, \
