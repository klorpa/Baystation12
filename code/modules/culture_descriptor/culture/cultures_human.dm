...
/singleton/cultural_info/culture/human/kuiper_outsider
	...
	Outsiders tend to be a more diverse demographic as compared to the Insiders, with many of them being descendants of employees on long-term tenures, or of families looking for cheap residence. \
	Most Outsiders tend to have a similar outlook of their home as that of the Insiders - with the Expeditionary Corps and Fleet being lucrative and comparatively easy ways to source a life outside the Kuiper belt."
	economic_power = 0.7
	secondary_langs = list (LANGUAGE_HUMAN_EURO,
		LANGUAGE_HUMAN_CHINESE,
		LANGUAGE_HUMAN_ARABIC,
...
/singleton/cultural_info/culture/human/iolaus
	...
	description = "An old colonial project of the Terran Commonwealth that survived a period of forced isolation, Iolaus has declared itself the capital of the fledgling and jingoistic Frontier Alliance. \
...
/singleton/cultural_info/culture/human/brahe
	...
	an exploratory spirit, Brahites find themselves cut off from their homeworld by the Copernican Blockade, and their relationship to the fledgling Frontier Alliance  \
...
/singleton/cultural_info/culture/human/pirx_bug
	...
	description = "The Bugeaters, named for the prevalence of insect protein within the Yuodu City Administrative District, make up the majority of the population of Pirx Prime. \
...
/singleton/cultural_info/culture/human/offworld
	...
	those who live so far from anything only look to their close family and friends rather than any larger group. Whether it's a fueling station, an agricultural dome, or a planet that is far removed from \
