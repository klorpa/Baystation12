...
/atom/proc/BorgCtrlAltClick(mob/living/silicon/robot/user) //forward to human click if not overridden
	CtrlAltClick(user)
...
/obj/machinery/door/airlock/BorgCtrlShiftClick() // Electrifies doors. Forwards to AI code.
